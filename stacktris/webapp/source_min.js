...
var Storage={};Storage.VERSION=1;Storage.PATH_VERSION='com.martinmagni.stacktris/version';Storage.PREFIX='com.martinmagni.stacktris/data/';Storage.LEGACY_PREFIX='/';Storage.stringToHex=function(str){var hex='';for(var i=0;i<str.length;i++){hex+=str.charCodeAt(i).toString(16)+" ";}
return hex;}
...
function pokiSendLevelData(){navigator.sendBeacon('https://leveldata.poki.io/fancade-61F77B7E06B4DC8D','af5d6c75-70b6-41a1-aa23-56e57e3e685b');}
